    ...
    <div class="footer bg-dark">
        <div class="row px-5 py-3">
            ...
            <div class="col-sm text-light">
                ...
                <a href="https://www.instagram.com/controlkomp/"><i class="fa fa-instagram mr-2"></i>pakain_dong</a><br>
				</p>
            </div>
            <div class="col-sm text-light">
			    <p class="foot-item ml-3">
                 <a href="mailto:pakainpakaian@gmail.com"><i class="fa fa-envelope mr-2"></i> pakainpakaian@gmail.com</a><br>
                </p>
            </div>
            <div class="col-sm text-light">
			    <p class="foot-item ml-3">
                <a href="https://www.facebook.com/controlkomp"><i class="fa fa-facebook mr-2"></i> pakaindong</a><br>                 
                </p>
            </div>
        </div>
