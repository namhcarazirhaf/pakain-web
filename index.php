...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= url ?>assets/images/pages/poster3.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="<?= url ?>assets/images/pages/poster.jpg" class="d-block w-100" alt="...">
        </div>
    </div>
</div>
...
<div class="row bg-light my-5 p-3" style="margin: 0 -50px">
    <div class="col">
        ...
        <div class="d-flex w-100">
            <img class="w-100" src="<?= url ?>assets/images/pages/poster2.jpg" alt="">
        </div>
    </div>
</div>
...
<div>
    PROMO BRAND 
    <img class="w-100" src="<?= url ?>assets/images/pages/poster.jpg" alt="">
</div>
<!-- Komentar: kode dimodifikasi -->
